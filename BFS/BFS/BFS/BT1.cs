...
namespace _22DH110153_PhamTuanAnh_LAB_3_
{
    internal class BT1
    {
        ...
        public bool readData(string path)
        {
            ...
            this.v = int.Parse(listA[0].Split(' ', (char)StringSplitOptions.RemoveEmptyEntries)[1]);

            //2 interger is seperated by the space and we gonna extract them then parse in n and v
